...
RELEASE_VERSION = "2.2.0 (dev 2)" # Public release version code
...
def calc_leaderboard(**params):
    ...
    gevent.sleep()
    # Combine for sorting
    leaderboard = zip(callsigns, max_laps, total_time, average_lap, fastest_lap, team_names, consecutives, fastest_lap_source)
