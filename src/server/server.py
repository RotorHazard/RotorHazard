...
RELEASE_VERSION = "4.1.0-beta.4" # Public release version code
...
SOCKET_IO = SocketIO(async_mode='gevent', cors_allowed_origins=RaceContext.serverconfig.get_item('GENERAL', 'CORS_ALLOWED_HOSTS'), max_http_buffer_size=5e7)
if __name__ == "__main__":
