...
def rank_best_rounds(rhapi, race_class, args):
    ...
    for pilotresultlist in pilotresults:
        ...
        new_pilot_result['total_time'] = RHUtils.format_time_to_str(new_pilot_result['total_time_raw'], timeFormat)
        new_pilot_result['total_time_laps'] = RHUtils.format_time_to_str(new_pilot_result['total_time_laps_raw'], timeFormat)
