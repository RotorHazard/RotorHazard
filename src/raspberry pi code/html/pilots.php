...
<div class="delta5-navigation mdl-layout__header-row">
	...
	<nav class="mdl-navigation">
		...
		<a class="delta5-navigation mdl-navigation__link" href="pilots.php"><button class="delta5-navigation mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Pilots</button></a>
