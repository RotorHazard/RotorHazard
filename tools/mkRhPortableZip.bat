@echo off
set RH_PYTHON_DIR=C:\WinApps\Python38\
...
7z a -r rhPortable.zip "%RH_PYTHON_DIR%" -xr0!Python38\Lib\test -x!*.pyc -x!__pycache__
sleep 2
...
sleep 1
7z rn rhPortable.zip Python38\ RotorHazardRun\Python38\
sleep 1
